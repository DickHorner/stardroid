...
class SearchArrowTest {
    @Test
    fun rightwardMovementUsesRightScreenEdgeAndOutwardAngle() {
        val marker = SearchArrow.computeEdgeMarker(
            1.0f,
            0.0f,
            500.0f,
            800.0f,
    ...
    @Test
    fun upwardMovementUsesTopScreenEdgeAndOutwardAngle() {
        val marker = SearchArrow.computeEdgeMarker(
            0.0f,
            1.0f,
            500.0f,
    ...
    @Test
    fun diagonalMovementIntersectsFirstScreenEdge() {
        val marker = SearchArrow.computeEdgeMarker(
            1.0f,
            1.0f,
            500.0f,
